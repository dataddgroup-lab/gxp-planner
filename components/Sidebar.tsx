...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-surface-card border-r border-surface-border flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-surface-border">
        ...
        <div>
          <p className="text-white text-sm font-semibold leading-tight">GxP Planner</p>
          <p className="text-slate-500 text-xs">Facility Intelligence</p>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-surface-border">
        <Link
          href="/auth/logout"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-500 hover:text-white hover:bg-surface transition-colors"
        >
